...
foreach(j = seq_len(nrow(design)), .export = exports) %dopar% {
  ...
  fit_CO2 <- brm(
    ...
    data = training_sel,
    prior = prior(R2D2(mean_R2 = 0.9, prec_R2 = 10)) + 
    ...
    # backend = "cmdstanr",
    file = paste0("models/fit_CO2_d", d, "_co", i, "_high_R2")
  )
  ...
  file_fit_varsel_50 <- paste0("models/fit_CO2_d", d, "_co", i, "_high_R2_varsel_50")  
  # not named after "nterms = 25" to avoid refitting already existing models
  file_fit_varsel_25 <- paste0("models/fit_CO2_d", d, "_co", i, "_high_R2_varsel")
  ...
  fit_CO2_b_sel_50 <- brm(
    ...
    backend = "rstan", stan_model_args = list(save_dso = FALSE),
    # backend = "cmdstanr",
    file = paste0("models/fit_CO2_d", d, "_co", i, "_high_R2_b_sel_50")
  )
  rm(fit_CO2_b_sel_50)
  ...
  fit_CO2_b_sel_25 <- brm(
    ...
    # backend = "cmdstanr",
    # not named after "nterms = 25" to avoid refitting already existing models
    file = paste0("models/fit_CO2_d", d, "_co", i, "_high_R2_b_sel")
  )
  rm(fit_CO2_b_sel_25)
